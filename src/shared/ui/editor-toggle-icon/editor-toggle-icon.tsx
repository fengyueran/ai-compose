...
export function EditorToggleIcon({ editorId }: EditorToggleIconProps) {
  if (editorId === 'antigravity') {
    return (
      ...
      >
        <defs>
          <linearGradient
            id="editor-icon-antigravity-arc"
            x1="6.4"
            y1="5.6"
            x2="17.6"
            y2="5.6"
  ...
  if (editorId === 'grok') {
    return (
      <svg
        aria-hidden="true"
        className="editor-icon-toggle__icon editor-icon-toggle__icon--grok"
        viewBox="0 0 24 24"
      >
        <rect
          x="2.2"
          ...
          fill="#000000"
        />
        <path fill="#FFFFFF" d="M15.4 5.5h3.1L10.9 18.5H7.8L15.4 5.5Z" />
        <path
          fill="#FFFFFF"
          opacity="0.65"
          d="M8.6 5.5h2.9L6.5 14H3.6L8.6 5.5Z"
        />
      </svg>
    );
  }
  ...
  return (
    ...
    >
      ...
      />
      <path
        fill="url(#editor-icon-cursor-top)"
        d="M12 5.4 17.4 8.55 12 11.35 6.6 8.55 12 5.4Z"
      />
      <path
        fill="url(#editor-icon-cursor-left)"
        d="M6.6 8.55v6.2L12 18V11.35L6.6 8.55Z"
      />
      <path
        fill="url(#editor-icon-cursor-right)"
        d="M17.4 8.55v6.2L12 18V11.35l5.4-2.8Z"
      />
      <path
        fill="url(#editor-icon-cursor-base)"
        opacity="0.82"
        d="M6.6 14.75 12 18l5.4-3.25L12 13.05l-5.4 1.7Z"
      />
    </svg>
  );
}
